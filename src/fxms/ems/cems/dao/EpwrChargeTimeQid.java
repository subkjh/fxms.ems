...
* database : null<br>
* sql <br><br>
 * <br>update	FE_EPWR_CHARGE_TIME a<br>		set		PEAK_USE_DTM = ( <br>					select 	max(ENG_DTM) 				 <br>					from 	FE_ENG_MEASR_AMT_INLO t1 <br>					where 	t1.ENG_DTM BETWEEN concat(a.YYYYMMDDHH, '0000') and concat(a.YYYYMMDDHH, '5959') <br>					and 	t1.DTM_TYPE 	= '15M' <br>					and 	t1.INLO_NO 		= a.INLO_NO <br>					and 	t1.ENG_ID 		= 'E11'<br>					and		t1.CONS_AMT * 4	= a.PEAK_USE_EPWR<br>				)<br>				, CHG_DTM =  DATE_FORMAT(now(), '%Y%m%d%H%i%s')<br>		where	a.YYYYMMDDHH between concat($date, '00') and concat($date, '23')<br><br> <br>
*/
