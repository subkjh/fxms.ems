...
* database : null<br>
* sql <br><br>
 * <br>insert into FE_EPWR_CHARGE ( INLO_NO, YYYY_MM, KEPCO_USED_AMT, KEPCO_CHARGE, REG_USER_NO, REG_DTM, CHG_USER_NO, CHG_DTM )<br>		with datas as (<br>			select 	a.INLO_NO			as INLO_NO<br>					, b.PAY_YYYYMM		as YYYY_MM<br>					, b.TOTAL_ENERGY	as KEPCO_USED_AMT<br>					, b.TOTAL_PRICE 	as KEPCO_CHARGE<br>					, 1					as REG_USER_NO		<br>					, DATE_FORMAT(now(), '%Y%m%d%H%i%s')<br>										as REG_DTM<br>					, 1					as CHG_USER_NO<br>					, DATE_FORMAT(now(), '%Y%m%d%H%i%s')<br>										as CHG_DTM<br>			from	FE_EPWR_INLO a<br>					, KEPCO_PP_EPWR_PRICE b<br>			where	a.KEPCO_PP_ID 	= b.KEPCO_PP_ID<br>			and		b.PAY_YYYYMM	= $yyyymm<br>		)<br>		select 	a.*<br>		from 	datas a<br>		on duplicate key update			<br>			KEPCO_USED_AMT 	= a.KEPCO_USED_AMT<br>			, KEPCO_CHARGE 	= a.KEPCO_CHARGE<br>			, CHG_DTM		= a.CHG_DTM<br><br> <br>
*/
