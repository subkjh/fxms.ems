...
public class GemvaxDbCron extends Crontab {
	...
	private final String VAR_NAME_TRADING = "vup-gemvex-trading-seqno";
	private final String VAR_NAME_SETTLEMENT = "vup-gemvex-settlement-yyyymm";
...
//		System.out.println(clacYm);
	...
	private long getLastTrnsNo() throws Exception {
		...
		VarApi.getApi().updateVarInfo(VAR_NAME_TRADING, varInfo);

		long seqno = VarApi.getApi().getVarValue(VAR_NAME_TRADING, 0L);
		return seqno;
	...
	private String getSettlementYyyymmdd() throws Exception {
		...
		VarApi.getApi().updateVarInfo(VAR_NAME_SETTLEMENT, varInfo);

		String yyyymmdd = VarApi.getApi().getVarValue(VAR_NAME_SETTLEMENT, "202001");
		return yyyymmdd;

	}

	private void setLastTrnsNo(long trnsNo) throws Exception {
		VarApi.getApi().setVarValue(VAR_NAME_TRADING, trnsNo, false);
	}
}
