...
/**
 * @description VUP에너지거래정산테이블
 * @author fxms auto
 * @date 20230503
 */

public class VupEngTransCalcDto implements Serializable {

	private static final long serialVersionUID = 1L;

	public VupEngTransCalcDto() {
	}

	@FxAttr(description = "공장PID", example = "F010001")
	private String plantPid;

	@FxAttr(description = "에너지ID", example = "E01")
	private String engTid;

	@FxAttr(description = "정산년월", example = "202304")
	private String calcYm;

	@FxAttr(description = "싱크소스구분", example = "SINK")
	...
	@FxAttr(description = "사용단가", required = false)
	...
	@FxAttr(description = "기본요금", required = false)
