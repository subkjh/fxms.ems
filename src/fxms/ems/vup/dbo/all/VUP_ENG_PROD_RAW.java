...
@FxTable(name = "VUP_ENG_PROD_RAW", comment = "에너지생산(공급)테이블")
@FxIndex(name = "VUP_ENG_PROD_RAW__PK", type = INDEX_TYPE.PK, columns = {"PROD_DTM", "INLO_NO", "ENG_ID"})
public class VUP_ENG_PROD_RAW implements Serializable {

public VUP_ENG_PROD_RAW() {
 }
