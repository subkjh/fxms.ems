...
@FxIndex(name = "FE_ENG_TRANS_BAS__FK1", type = INDEX_TYPE.FK, columns = {
		"ENG_ID" }, fkTable = "FE_ENG_BAS", fkColumn = "ENG_ID")
@FxIndex(name = "FE_ENG_TRANS_BAS__FK2", type = INDEX_TYPE.FK, columns = {
		"UNIT_PRICE_TBL_ID" }, fkTable = "FE_ENG_TRANS_PRICE", fkColumn = "UNIT_PRICE_TBL_ID")
...
public class FE_ENG_TRANS_BAS {
	...
	@FxColumn(name = "TRNS_DTM", size = 14, nullable = true, comment = "거래일시")
	private Long trnsDtm;
	...
	public Long getTrnsDtm() {
		return trnsDtm;
	}

	public void setTrnsDtm(Long trnsDtm) {
