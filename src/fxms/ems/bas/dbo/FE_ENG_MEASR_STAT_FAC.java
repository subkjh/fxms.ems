...
@FxTable(name = "FE_ENG_MEASR_STAT_FAC", comment = "에너지계측량통계설비별테이블")
@FxIndex(name = "FE_ENG_MEASR_STAT_FAC__PK", type = INDEX_TYPE.PK, columns = {"ENG_DATE","ENG_ID","FAC_NO"})
@FxIndex(name = "FE_ENG_MEASR_STAT_FAC__FK1", type = INDEX_TYPE.FK, columns = {"ENG_ID"}, fkTable = "FE_ENG_BAS", fkColumn = "ENG_ID")
public class FE_ENG_MEASR_STAT_FAC  {

public FE_ENG_MEASR_STAT_FAC() {
 }
