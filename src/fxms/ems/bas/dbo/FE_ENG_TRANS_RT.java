...
@FxIndex(name = "FE_ENG_TRANS_RT__FK1", type = INDEX_TYPE.FK, columns = {"ENG_RT_ID"}, fkTable = "FE_ENG_RT_BAS", fkColumn = "ENG_RT_ID")
@FxIndex(name = "FE_ENG_TRANS_RT__FK2", type = INDEX_TYPE.FK, columns = {"TRNS_NO"}, fkTable = "FE_ENG_TRANS_BAS", fkColumn = "TRNS_NO")
