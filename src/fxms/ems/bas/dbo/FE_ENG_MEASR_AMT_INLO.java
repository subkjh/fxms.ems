...
@FxTable(name = "FE_ENG_MEASR_AMT_INLO", comment = "에너지계측량설치위치별테이블")
@FxIndex(name = "FE_ENG_MEASR_AMT_INLO__PK", type = INDEX_TYPE.PK, columns = {"ENG_DTM","DTM_TYPE","ENG_ID","INLO_NO"})
@FxIndex(name = "FE_ENG_MEASR_AMT_INLO__FK1", type = INDEX_TYPE.FK, columns = {"ENG_ID"}, fkTable = "FE_ENG_BAS", fkColumn = "ENG_ID")
public class FE_ENG_MEASR_AMT_INLO  {

public FE_ENG_MEASR_AMT_INLO() {
 }
