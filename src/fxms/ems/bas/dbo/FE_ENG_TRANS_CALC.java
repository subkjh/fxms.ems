...
@FxTable(name = "FE_ENG_TRANS_CALC", comment = "에너지거래정산테이블")
@FxIndex(name = "FE_ENG_TRANS_CALC__PK", type = INDEX_TYPE.PK, columns = {"TRNS_NO","CALC_YM"})
@FxIndex(name = "FE_ENG_TRANS_CALC__FK1", type = INDEX_TYPE.FK, columns = {"TRNS_NO"}, fkTable = "FE_ENG_TRANS_BAS", fkColumn = "TRNS_NO")
public class FE_ENG_TRANS_CALC  {

public FE_ENG_TRANS_CALC() {
 }
