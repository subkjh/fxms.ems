...
@FxAdapterInfo(service = "AppService", descr = "에너지 생산,소비량 데이터 생성하기")
public class MakeEnergyAmtStatCron extends Crontab {

	@FxAttr(name = "schedule", description = "실행계획", value = "3,18,33,48 * * * *")
	private String schedule;

	public MakeEnergyAmtStatCron() {
	...
	public void start() throws Exception {
		...
		final String VAR_NAME = "fems-energy-made-time-amt-stat";

		try {

			Map<String, Object> varInfo = new HashMap<String, Object>();
			varInfo.put("varGrpName", "TIME");
			varInfo.put("varDispName", "에너지량 생성일시");
